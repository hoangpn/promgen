...
class PermissionManagementMixin:
    ...
    def assign_user(self, request, id):
        ...
        return self.members(request, id)
    ...
    @extend_schema(
        ...
        responses={"204": serializers.UserWithPermRetrieveSerializer(many=True)},
    )
    @action(
        detail=True,
        methods=["delete"],
    ...
    def remove_member(self, request, id, member_id):
    ...
    @extend_schema(
        ...
        responses={"204": serializers.GroupWithPermRetrieveSerializer(many=True)},
    )
    @action(
        detail=True,
        methods=["delete"],
    ...
    def remove_group(self, request, id, member_id):
        remove_sub_permissions = (
            request.query_params.get("remove_sub_permissions", "true").lower() == "true"
        )
        member = models.Group.objects.get(id=member_id)
        self.remove_perm(member, remove_sub_permissions)
        return self.members(request, id)
...
class ProjectViewSet(
    ...
    def unlink_farm(self, request, id):
        ...
        if project.farm is None:
            return Response(serializers.ProjectRetrieveDetailSerializer(project).data)
